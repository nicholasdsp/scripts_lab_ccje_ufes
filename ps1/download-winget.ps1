...
{
    Invoke-WebRequest -Uri "http://ccje-websrv1/repositorio/Microsoft.VCLibs.140.00.UWPDesktop_14.0.33728.0_x64__8wekyb3d8bbwe.Appx" -OutFile "./ps1/winget-dependencies/Microsoft.VCLibs.140.00.UWPDesktop_14.0.33728.0_x64__8wekyb3d8bbwe.appx"
}